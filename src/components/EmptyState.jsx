...
const EmptyState = () => {
    return (
        <div style={{
            ...
            />
            <h1 style={{ fontWeight: 300, color: 'var(--primary-strong)', margin: '20px 0 10px 0' }}>WhatsApp para Windows</h1>
            <p style={{ color: 'var(--secondary)', fontSize: '14px', lineHeight: '20px', maxWidth: '400px' }}>
            ...
            <div style={{ position: 'absolute', bottom: '40px', fontSize: '13px', color: 'var(--secondary-lighter)', display: 'flex', alignItems: 'center', gap: '5px' }}>
